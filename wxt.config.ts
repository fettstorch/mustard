...
export default defineConfig({
  ...
  manifest: ({ browser }) => ({
    ...
    // Windows overrides avoid NVIDIA's Alt+Shift+Z overlay, Chrome's reserved
    // Alt+Shift+A command, and Windows' own Alt+Shift language switch while
    // preserving mnemonic shortcuts.
    commands: {
